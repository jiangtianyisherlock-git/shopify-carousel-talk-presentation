...
import { getChapterAutoAdvanceDelay } from "./lib/chapterAutoAdvance";
...
export default function App() {
  ...
  useEffect(() => {
    const delay = getChapterAutoAdvanceDelay(ch, stepper.cursor.step, false);
    if (delay === null) return;
    const timer = window.setTimeout(stepper.next, delay);
    return () => window.clearTimeout(timer);
  }, [ch, stepper.cursor.step, stepper.next]);
