...
export interface ChapterDef {
  ...
  /** Optional chapter-local visual auto progression. Never crosses chapters. */
  autoAdvance?: {
    delayMs: number;
    /** Shared time budget for the full in-frame reveal sequence. */
    totalDurationMs?: number;
    /** First step in the in-frame reveal sequence. Earlier steps remain manual. */
    sequenceStartStep?: number;
    throughStep?: number;
